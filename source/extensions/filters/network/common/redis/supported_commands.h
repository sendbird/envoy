...
struct SupportedCommands {
  ...
  static const absl::flat_hash_set<std::string>& simpleCommands() {
    CONSTRUCT_ON_FIRST_USE(
        ...
        "smembers", "spop", "spublish", "srandmember", "srem", "sscan", "ssubscribe", "strlen",
        "subscribe", "sunsubscribe", "ttl", "type", "watch", "xack", "xadd", "xautoclaim", "xclaim",
        "xdel", "xlen", "xpending", "xrange", "xrevrange", "xtrim", "zadd", "zcard", "zcount",
        ...
        "smove", "sunion", "sdiff", "sinter", "sinterstore", "zunionstore", "zinterstore", "pfmerge",
        "georadius", "georadiusbymember", "rename", "sort", "sort_ro", "zmscore", "sdiffstore",
        "msetnx", "substr", "zrangestore", "zunion", "zdiff", "sunionstore", "smismember",
        "hrandfield", "geosearchstore", "zdiffstore", "zinter", "zrandmember", "bitop", "lpos",
        "renamenx");
  }
